...
def start_vllm_server(model_path: str, port: int) -> None:
    ...
    vllm_cmd = [
        ...
        "--max-model-len", "32768",         # keep — good for dealership calls
        "--max-num-batched-tokens", "32768", # uncomment and set to match
        "--gpu-memory-utilization", "0.8",  # was 0.78 — more room for KV cache
